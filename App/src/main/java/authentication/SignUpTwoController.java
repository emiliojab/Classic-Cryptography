 ...
 * @author User
 */
public class SignUpTwoController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        user = authentication.SignUpControler.user;
    }
            ...
            protected Task<Void> createTask() {
                return new Task<Void>() {
                    ...
                    protected Void call() throws Exception {
                        ...
                        String q = "select * from `login`.`users` where `name`=? and `password`=?";
                        ...
                        try {
                            ...
                            if (count == 1) {
                                ...
                                user.setSevleveltwo(secLevelTwo);
                                String q1 = "UPDATE `login`.`users` SET `secleveltwo` = ? WHERE `name` = ?;";
                                dbConnection = handler.getConnection();

                                pst = dbConnection.prepareStatement(q1);
                                pst.setString(1, secLevelTwo);
